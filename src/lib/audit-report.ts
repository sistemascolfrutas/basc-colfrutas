...
function formatLabel(key: string) {
  const custom: Record<string, string> = {
    ...
    orden_aseo_cabina: "Orden y aseo dentro de la cabina",
    puertas_ajustadas_cabina: "Puertas ajustadas",
    techo_cabina_buen_estado: "Techo de cabina en buen estado",
    piso_interior_remolque_limpio: "Estado del piso e interior del remolque",
    estado_puertas_furgon: "Estado de puertas del furgon",
    estado_bastidores: "Estado de bastidores",
    defensa_trasera: "Defensa trasera",
    parachoques_neumaticos_rines: "Parachoques, neumaticos y rines",
    puertas_compartimientos_herramientas: "Puertas y compartimientos de herramientas",
    caja_bateria: "Caja de bateria",
    caja_filtro_aire: "Caja y filtro de aire",
    tanque_combustible: "Tanque de combustible",
    compartimiento_interior_cabina_dormitorio: "Compartimiento interior de la cabina y dormitorio",
    rompevientos_deflectores_techo: "Rompevientos, deflectores y techo",
    soportes_metalicos_carroceria_furgon: "Soportes metalicos de la carroceria o furgon",
    quinta_rueda: "Quinta rueda",
    pata_mecanica_trailer: "Pata mecanica",
    areas_quinta_rueda: "Areas de quinta rueda",
    lado_derecho_trailer: "Lado derecho del trailer",
    lado_izquierdo_trailer: "Lado izquierdo del trailer",
    llantas_parachoques_luces_trailer: "Llantas, parachoques y luces",
    placa_patin_trailer: "Placa del patin",
    puntos_anclaje_trailer_contenedor: "Puntos de anclaje o seguro del trailer al contenedor",
