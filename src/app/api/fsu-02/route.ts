...
export async function POST(request: Request) {
  ...
  try {
    ...
    const input: Fsu02Input = {
      ...
      ordenAseoCabina: parseBoolean(formData.get("ordenAseoCabina")),
      puertasAjustadasCabina: parseBoolean(formData.get("puertasAjustadasCabina")),
      techoCabinaBuenEstado: parseBoolean(formData.get("techoCabinaBuenEstado")),
      pisoInteriorRemolqueLimpio: parseBoolean(formData.get("pisoInteriorRemolqueLimpio")),
      estadoPuertasFurgon: parseBoolean(formData.get("estadoPuertasFurgon")),
      estadoBastidores: parseBoolean(formData.get("estadoBastidores")),
      defensaTrasera: parseBoolean(formData.get("defensaTrasera")),
      parachoquesNeumaticosRines: parseBoolean(formData.get("parachoquesNeumaticosRines")),
      puertasCompartimientosHerramientas: parseBoolean(formData.get("puertasCompartimientosHerramientas")),
      cajaBateria: parseBoolean(formData.get("cajaBateria")),
      cajaFiltroAire: parseBoolean(formData.get("cajaFiltroAire")),
      tanqueCombustible: parseBoolean(formData.get("tanqueCombustible")),
      compartimientoInteriorCabinaDormitorio: parseBoolean(formData.get("compartimientoInteriorCabinaDormitorio")),
      rompevientosDeflectoresTecho: parseBoolean(formData.get("rompevientosDeflectoresTecho")),
      soportesMetalicosCarroceriaFurgon: parseBoolean(formData.get("soportesMetalicosCarroceriaFurgon")),
      quintaRueda: parseBoolean(formData.get("quintaRueda")),
      pataMecanicaTrailer: parseBoolean(formData.get("pataMecanicaTrailer")),
      areasQuintaRueda: parseBoolean(formData.get("areasQuintaRueda")),
      ladoDerechoTrailer: parseBoolean(formData.get("ladoDerechoTrailer")),
      ladoIzquierdoTrailer: parseBoolean(formData.get("ladoIzquierdoTrailer")),
      llantasParachoquesLucesTrailer: parseBoolean(formData.get("llantasParachoquesLucesTrailer")),
      placaPatinTrailer: parseBoolean(formData.get("placaPatinTrailer")),
      puntosAnclajeTrailerContenedor: parseBoolean(formData.get("puntosAnclajeTrailerContenedor")),
