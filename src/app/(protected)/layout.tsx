...
const navItems = [
  ...
  { href: "/precintos", label: "ENTRADA DE PRECINTO", permission: "precintos" as const },
  { href: "/salida-precintos", label: "SALIDA DE PRECINTO", permission: "precintos" as const },
